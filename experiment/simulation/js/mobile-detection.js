      ...
      <div class="mobile-overlay-backdrop">
        <div class="mobile-overlay-content">
          ...
          <p class="mobile-overlay-description">
            This simulation is optimized for desktop computers with larger screens and mouse interaction.<br>
            If you continue on mobile, please rotate your device to <b>landscape mode</b> for the best experience.<br>
            You may experience:
          </p>
          <ul class="mobile-overlay-list">
            <li>• Difficulty interacting with form elements</li>
            <li>• Limited screen space for code and controls</li>
          ...
          <div class="mobile-overlay-actions">
            <button class="mobile-overlay-btn mobile-overlay-btn-primary" onclick="mobileDetection.continueAnyway()">
              Continue Anyway (Landscape Mode)
            </button>
          ...
          <p class="mobile-overlay-footer">
            For the best learning experience, please access this simulation on a desktop or laptop computer.<br>
            If you must use a mobile device, use it in <b>landscape mode</b>.
          </p>
        </div>
      </div>
    `;
